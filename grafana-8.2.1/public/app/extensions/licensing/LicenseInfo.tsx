...
import { EXPIRED, VALID, WARNING_RATE } from './constants';
...
export const LicenseInfo = ({ token, stats, tokenRenewed, tokenUpdated }: Props) => {
  ...
  return !token || ![VALID, EXPIRED].includes(token.status) ? (
    <>
      ...
      <div className={styles.uploadWrapper}>
        <LicenseTokenUpload title="Have a license?" onFileUpload={onFileUpload} isUploading={isUploading} />
      </div>
    </>
  ) : (
    <div>
      ...
      <div className={styles.row}>
        ...
        <LicenseCard
          ...
          footer={
            <div className={styles.row}>
              <LicenseTokenUpload onFileUpload={onFileUpload} isUploading={isUploading} />
              {isRenewing ? (
                <span> (Renewing...)</span>
              ) : (
                <Button variant="secondary" onClick={onRenewClick}>
                  Renew token
                </Button>
              )}
            </div>
